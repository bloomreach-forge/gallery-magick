...
public class NewsDocument extends HippoDocument {
     ...
     */
    public static final String DOCUMENT_TYPE = "gallerymagickdemo:newsdocument";

    private static final String TITLE = "gallerymagickdemo:title";
    private static final String DATE = "gallerymagickdemo:date";
    private static final String INTRODUCTION = "gallerymagickdemo:introduction";
    private static final String IMAGE = "gallerymagickdemo:image";
    private static final String CONTENT = "gallerymagickdemo:content";
    private static final String LOCATION = "gallerymagickdemo:location";
    private static final String AUTHOR = "gallerymagickdemo:author";
    private static final String SOURCE = "gallerymagickdemo:source";
